...
public class SubmitAfterSavingDebitNote_Test extends TestBase {
    ...
    public void createNewDebitNote() throws InterruptedException, AWTException {
        ...
        debitNotePageObject.getDebitNoteNameAfterSaving();
        debitNotePageObject.submitAfterSavingDebitNote();
